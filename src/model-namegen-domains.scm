...
(define (domain0-names)
  '("" "Adam" "Adlai" "Agatha" "Ahmed" "Alan" "Alastair" "Albert" "Alexander" "Alexis" "Alfred" "Alison"
    "Alvin" "Amanda" "Amir" "Amos" "Anatoly" "Andrea" "Andreas" "Andrew" "Angela" "Angus" "Anton" "Antonio"
    "Arne" "Arnold" "Arthur" "Audrey" "Avery" "Barbara" "Barney" "Barton" "Benjamin" "Benson" "Bernard"
    "Bertrand" "Beverly" "Bjorne" "Blaine" "Blair" "Blake" "Bradley" "Brandon" "Brendan" "Brent" "Bret"
    "Brian" "Brooke" "Bruce" "Bruno" "Bryce" "Caleb" "Calvin" "Carl" "Carlos" "Carol" "Carolyn" "Carsten"
    "Carter" "Cary" "Casey" "Casper" "Catherine" "Celeste" "Claire" "Clarence" "Clarissa" "Clark" "Claudia"
    "Claudio" "Cole" "Conrad" "Constantine" "Corey" "Cynthia" "Cyrus" "Donovan" "Dorothy" "Douglas" "Dylan"
    "Edgar" "Edith" "Eli" "Elias" "Elijah" "Elizabeth" "Elvis" "Elwood" "Emil" "Emily" "Emma" "Eric" "Ernst"
    "Erwin" "Ethan" "Eugene" "Eva" "Evan" "Evelyn" "Fay" "Felix" "Fletcher" "Florian" "Francisco" "Fred"
    "Fritz" "Gabriel" "Gail" "Gary" "Geoffrey" "George" "Giovanni" "Gordon" "Graham" "Gregor" "Heather"
    "Hector" "Horatio" "Howard" "Hubert" "Hugh" "Hunter" "Ilya" "Ira" "Isaac" "Izumi" "Janos" "Jared" "Jeremy"
    "Jerome" "Jesse" "Jin" "Jiri" "Joel" "Jonathan" "Jose" "Klaus" "Knut" "Konrad" "Laurel" "Lee" "Leigh"
    "Len" "Lester" "Lev" "Lex" "Lila" "Lindsay" "Lois" "Louis" "Louise" "Luc" "Lucas" "Lucius" "Luis" "Luke"
    "Magnus" "Manuel" "Marco" "Marcus" "Marek" "Margot" "Maria" "Mario" "Marlena" "Marnie" "Martha" "Martin"
    "Marvin" "Mason" "Matthias" "Max" "Michael" "Miles" "Milo" "Miriam" "Mohammad" "Molly" "Morgan" "Moses"
    "Myron" "Nanda" "Naomi" "Narendra" "Nathaniel" "Neville" "Nguyen" "Niall" "Nicholas" "Nigel" "Nils"
    "Noam" "Nora" "Oleg" "Oliver" "Omar" "Oscar" "Owen" "Pablo" "Pia" "Piet" "Pilar" "Prakash" "Ragnar"
    "Rainer" "Ram" "Ramon" "Ramsey" "Raphael" "Raul" "Ravi" "Ray" "Rex" "Rhys" "Roberto" "Robin" "Roland"
    "Roman" "Roxanne" "Rudolf" "Rupert" "Ruth" "Sabrina" "Sally" "Samir" "Samuel" "Sandeep" "Sanjay" "Saul"
    "Sergio" "Seth" "Simon" "Skip" "Sofia" "Sriram" "Sunil" "Suresh" "Susan" "Takao" "Terence" "Timothy"
    "Tobias" "Valentin" "Valerie" "Victoria" "Vijay" "Vinod" "Vladimir" "Walter" "Wendy" "Wilhelm" "William"
    "Winifred" "Winston" "Wolfgang" "Woody"))
