...
(define (make-adlivun-cell)
  (let* ((pivot (Node "Adlivun Cell"))
         ...
         (pyramid00-geom::Geometry (make-pyramid 84.0 (ColorRGBA 0.5 0.0 0.0 0.5)(ColorRGBA 0.5 0.5 0.5 0.5)))
         (pyramid000-geom::Geometry (make-pyramid 7.0 (ColorRGBA 0.8 0.5 0.5 0.5)(ColorRGBA 0.8 0.5 0.5 0.5)))
         ;; pyramid01 -- the right-hand interior pyramid
         (pyramid01-geom::Geometry (make-pyramid 84.0 (ColorRGBA 0.5 0.0 0.0 0.5)(ColorRGBA 0.5 0.5 0.5 0.5)))
         (pyramid010-geom::Geometry (make-pyramid 7.0 (ColorRGBA 0.8 0.5 0.5 0.5)(ColorRGBA 0.8 0.5 0.5 0.5)))
         ;; pyramid02 -- the rear interior pyramid
         (pyramid02-geom::Geometry (make-pyramid 84.0 (ColorRGBA 0.5 0.0 0.0 0.5)(ColorRGBA 0.5 0.5 0.5 0.5)))
         (pyramid020-geom::Geometry (make-pyramid 7.0 (ColorRGBA 0.8 0.5 0.5 0.5)(ColorRGBA 0.8 0.5 0.5 0.5)))
         ;; pyramid03 -- the left interior pyramid
         (pyramid03-geom::Geometry (make-pyramid 84.0 (ColorRGBA 0.5 0.0 0.0 0.5)(ColorRGBA 0.5 0.5 0.5 0.5)))
         (pyramid030-geom::Geometry (make-pyramid 7.0 (ColorRGBA 0.8 0.5 0.5 0.5)(ColorRGBA 0.8 0.5 0.5 0.5)))
         ;; pyramid04 -- the front interior pyramid
         (pyramid04-geom::Geometry (make-pyramid 84.0 (ColorRGBA 0.5 0.0 0.0 0.5)(ColorRGBA 0.5 0.5 0.5 0.5)))
         (pyramid040-geom::Geometry (make-pyramid 7.0 (ColorRGBA 0.8 0.5 0.5 0.5)(ColorRGBA 0.8 0.5 0.5 0.5)))
         ;; pyramid05 -- the top interior pyramid
         (pyramid05-geom::Geometry (make-pyramid 84.0 (ColorRGBA 0.5 0.0 0.0 0.5)(ColorRGBA 0.5 0.5 0.5 0.5)))
         (pyramid050-geom::Geometry (make-pyramid 7.0 (ColorRGBA 0.8 0.5 0.5 0.5)(ColorRGBA 0.8 0.5 0.5 0.5)))
         ;; pyramid06 -- the bottom interior pyramid
         (pyramid06-geom::Geometry (make-pyramid 84.0 (ColorRGBA 0.5 0.0 0.0 0.5)(ColorRGBA 0.5 0.5 0.5 0.5)))
         (pyramid060-geom::Geometry (make-pyramid 7.0 (ColorRGBA 0.8 0.5 0.5 0.5)(ColorRGBA 0.8 0.5 0.5 0.5))))
